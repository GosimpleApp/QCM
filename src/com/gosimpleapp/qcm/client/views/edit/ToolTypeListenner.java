...
public class ToolTypeListenner extends MouseListenerAdapter{
	  ...
	  public ToolTypeListenner(String text, int delay) {
	    this(text, delay, DEFAULT_TOOLTIP_STYLE);
	  }

	  public ToolTypeListenner(String text, int delay, String styleName) {
	    this.text = text;
	    this.delay = delay;
